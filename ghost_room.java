public class ghost_room {
    public static void main(int[] array) {
        ...
        while(list_element<=last_list){
            if(main_list[list_element][small_list_element] != 0 && list_element+2 <= last_list){
                if(main_list[list_element+2][small_list_element] != 0){
                    sum = sum + main_list[list_element+1][small_list_element];
                }
            }
